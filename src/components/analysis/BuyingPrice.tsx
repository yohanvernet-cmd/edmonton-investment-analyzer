    ...
    <div className="card mt-6 border-2 border-green-200 bg-green-50">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 border border-green-200">
          <div className="text-sm text-green-600 font-medium">Target DSCR 1.10 (Minimum to qualify with rent proof)</div>
        ...
        <div className="bg-white rounded-lg p-4 border border-green-200">
          <div className="text-sm text-green-600 font-medium">Target DSCR 1.20 (Requested by CMHC)</div>
