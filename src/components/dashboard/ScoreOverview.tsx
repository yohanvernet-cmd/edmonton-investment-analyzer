...
export function ScoreOverview({ score }: { score: InvestmentScore }) {
  ...
  return (
    <div className="card flex flex-col items-center">
      <h3 className="text-sm font-medium text-slate-500 mb-4">Score d&apos;investissement</h3>
        ...
        {score.breakdown.map(b => (
          <div key={b.category}>
            ...
            <div className="progress-bar">
              <div
                className={`progress-bar-fill ${b.score / b.maxScore >= 0.7 ? 'bg-green-500' : b.score / b.maxScore >= 0.4 ? 'bg-yellow-500' : 'bg-red-500'}`}
